...
public class CricketAnalyser {
    ...
    public int getBattingDataFile(String csvFilePath) {
        try (Reader reader = Files.newBufferedReader(Paths.get(csvFilePath));) {
            ...
            Iterator<MostRunsCSV> mostRunsCSVIterator = icsvBuilder.getCSVFileIterator(reader, MostRunsCSV.class);
    ...
    public int getBowlingDataFile(String csvFilePath) {
        try (Reader reader = Files.newBufferedReader(Paths.get(csvFilePath));) {
            ICSVBuilder icsvBuilder = CSVBuilderFactory.createCSVBuilder();
            Iterator<MostWicketsCSV> mostWicketsCSVIterator = icsvBuilder.getCSVFileIterator(reader, MostWicketsCSV.class);
